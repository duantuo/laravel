...
@section('content')
		...
		<ul>
            <li>
                ...
                <ul class="sub_menu">
                    ...
                    <li><a href="{{url('admin/navs')}}" target="main"><i class="fa fa-fw fa-list-alt"></i>导航栏管理</a></li>
	...
	<div class="bottom_box">
		CopyRight © 2017. Powered By <a href="http://{{$_SERVER['SERVER_NAME']}}">http://{{$_SERVER['SERVER_NAME']}}</a>.
	</div>
	<!--底部 结束-->
@endsection